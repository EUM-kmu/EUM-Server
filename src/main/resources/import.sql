...
insert into market_post(market_post_id, contents, current_accepted_people, location, market_type, max_num_of_people,pay, slot, start_date, title, volunteer_time, category_id,  user_id, status,create_date,is_deleted)values (2, "과외 구함", 0, "국민 빌라", "PROVIDE_HELP", 4, 30, "ALL", "2024-08-13 00:00:00", "과외구함", "30", 4, 2, "RECRUITING",now(),0);
...
insert into market_post(market_post_id, contents, current_accepted_people, location, market_type, max_num_of_people,pay, slot, start_date, title, volunteer_time, category_id,  user_id, status,create_date,is_deleted)values (4, "연탄 나르기 ", 0, "국민 빌라", "REQUEST_HELP", 1, 30, "ALL", "2024-08-13 00:00:00", "연탄을 날라보자", "30", 1, 2, "RECRUITING",now(),0);
...
insert into withdrawal_category(withdrawal_category_id,content) VALUES (1,"앱을 쓰지 않아요"),(2,"알림이 너무 많이 와요"),(3,"비매너 사용자를 만났어요"),(4,"새 계정을 만들고 시퍼요"),(5,"기타")