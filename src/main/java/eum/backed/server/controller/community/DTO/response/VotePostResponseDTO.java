...
public class VotePostResponseDTO {
    ...
    public static SavedVotePost toSaveResponse(VotePost votePost, Users getUser,int agreeCount, int disagreeCount,int commentCount){
        ...
        String createdTime = KoreaLocalDateTime.localDateTimeToKoreaZoned(votePost.getCreateDate());
        String voteEndTime = KoreaLocalDateTime.dateToKoreaZone(votePost.getEndTime());
