...
public interface BankAccountTransactionRepository extends JpaRepository<BankAccountTransaction,Long> {
    ...
    Optional<List<BankAccountTransaction>> findByMyBankAccountAndTransactionTypeOrderByCreateDateDesc(UserBankAccount myBankAccount, TransactionType transactionType);
