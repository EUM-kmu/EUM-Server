...
insert into bank_account_transaction(bank_account_transaction_id  , amount ,code ,my_current_balance ,status ,branch_bank_account_id ,my_bank_account ,create_date,trasnaction_type)values (34,100000,"SUCCESS",100000,"INITIAL",1,3,now(),"DEPOSIT");
...
insert into market_post(market_post_id, contents, current_accepted_people, location, market_type, max_num_of_people,pay, slot, start_date, title, volunteer_time, category_id, user_id, status,create_date)values (3, "된장찌개 재료 장 봐와주세요", 0, "국민 빌라", "PROVIDE_HELP", 1, 30, "ALL", "2024-08-13 00:00:00", "장보기", "30", 4, 1, "RECRUITING",now());
insert into market_post(market_post_id, contents, current_accepted_people, location, market_type, max_num_of_people,pay, slot, start_date, title, volunteer_time, category_id,  user_id, status,create_date)values (4, "연탄 나르기 ", 0, "국민 빌라", "REQUEST_HELP", 1, 30, "ALL", "2024-08-13 00:00:00", "연탄을 날라보자", "30", 1, 2, "RECRUITING",now());
insert into market_post(market_post_id, contents, current_accepted_people, location, market_type, max_num_of_people,pay, slot, start_date, title, volunteer_time, category_id,  user_id, status,create_date)values (5, "바퀴벌레 잡아 줄 사람 구해요", 1, "국민 빌라", "REQUEST_HELP", 1, 30, "ALL", "2024-08-13 00:00:00", "쓰레기장", "30", 4, 2, "RECRUITMENT_COMPLETED",now());
insert into market_post(market_post_id, contents, current_accepted_people, location, market_type, max_num_of_people,pay, slot, start_date, title, volunteer_time, category_id,  user_id, status,create_date)values (6, "바퀴벌레 잡아 줄 사람 구해요", 1, "국민 빌라", "PROVIDE_HELP", 1, 30, "AM", "2024-08-13 00:00:00", "재롱잔치", "30", 2, 1, "RECRUITMENT_COMPLETED",now());
insert into market_post(market_post_id, contents, current_accepted_people, location, market_type, max_num_of_people,pay, slot, start_date, title, volunteer_time, category_id,  user_id, status,create_date)values (7, "바퀴벌레 잡아 줄 사람 구해요", 0, "국민 빌라", "REQUEST_HELP", 1, 30, "PM", "2024-08-13 00:00:00", "심부름", "30", 4, 1, "RECRUITING",now());
insert into market_post(market_post_id, contents, current_accepted_people, location, market_type, max_num_of_people,pay, slot, start_date, title, volunteer_time, category_id,  user_id, status,create_date)values (8, "바퀴벌레 잡아 줄 사람 구해요", 0, "국민 빌라", "PROVIDE_HELP", 1, 30, "ALL", "2024-08-13 00:00:00", "구걸", "30", 5, 2, "RECRUITING",now());
insert into market_post(market_post_id, contents, current_accepted_people, location, market_type, max_num_of_people,pay, slot, start_date, title, volunteer_time, category_id,  user_id, status,create_date)values (19, "바퀴벌레 잡아 줄 사람 구해요", 0, "국민 빌라", "REQUEST_HELP", 1, 30, "ALL", "2024-08-13 00:00:00", "모기박멸", "30", 4, 2, "RECRUITING",now());
